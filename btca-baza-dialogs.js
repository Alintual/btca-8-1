(function (global) {
  ...
  var TEXT_SCREENSHOT_FIRST =
    "Придумайте свой персональный идентификатор для файлов и далее Подтвердите запись скриншота и далее выберите Сохранить в Файлах";
  var TEXT_SCREENSHOT_CONFIRM =
    "Подтвердите запись скриншота и далее выберите Сохранить в Файлах";
  var TEXT_EXPORT_FIRST =
    "Придумайте свой персональный идентификатор для файлов и далее Подтвердите экспорт копии Базы данных и далее выберите Сохранить в Файлах";
  var TEXT_EXPORT_CONFIRM =
    "Подтвердите экспорт копии Базы данных и далее выберите Сохранить в Файлах";
  var TEXT_IMPORT_CONFIRM = "Подтвердите импорт копии Базы данных из Загрузки";
