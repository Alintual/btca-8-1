(function (global) {
  ...
  var TEXT_SCREENSHOT_FIRST =
    "Придумайте свой персональный идентификатор для файлов и далее Подтвердите запись скриншота в Загрузки";
  var TEXT_SCREENSHOT_CONFIRM = "Подтвердите запись скриншота в Загрузки";
  var TEXT_EXPORT_FIRST =
    "Придумайте свой персональный идентификатор для файлов и далее Подтвердите экспорт копии Базы данных в Загрузки";
  var TEXT_EXPORT_CONFIRM = "Подтвердите экспорт копии Базы данных в Загрузки";
