(function () {
  ...
  var INSTALL_CACHE = "btca-web-8.1.78:static-install";
  var MEDIA_CACHE = "btca-web-8.1.78:static-media";
  ...
  function applyInstalledPhraseOneNudge() {
    var el = document.querySelector(".home__phrase--one");
    if (!el) return;
    var rootFont = parseFloat(getComputedStyle(document.documentElement).fontSize) || 17;
    var shift = (10 * rootFont) / 17;
    el.style.transform = "translate(" + shift + "px, " + shift + "px) rotate(45deg)";
  }
